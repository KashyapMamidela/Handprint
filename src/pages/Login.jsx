      ...
      <div className="w-[400px] rounded-2xl border border-white/[0.09] bg-white/[0.045] p-10 shadow-[0_30px_60px_-30px_rgba(0,0,0,0.7)]">
        ...
        <div className="mb-6 flex flex-col gap-3">
          <button
            ...
            disabled
            title="Coming soon"
            className="flex h-12 cursor-not-allowed items-center justify-center gap-2.5 rounded-[10px] border border-white/[0.14] bg-white/[0.03] text-sm font-bold text-cream opacity-50"
          >
            <span
              className="h-[18px] w-[18px] rounded-full"
              style={{ background: 'conic-gradient(from 0deg,#e8c766,#59c2a4,#c98f5c,#e8c766)' }}
            />
          ...
          <button
            ...
            className="flex h-12 cursor-not-allowed items-center justify-center gap-2.5 rounded-[10px] border border-white/[0.14] bg-white/[0.03] text-sm font-bold text-cream opacity-50"
          >
            <span className="h-[18px] w-[18px] rounded bg-gradient-to-br from-green-200 to-green-400" />

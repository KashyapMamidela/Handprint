...
-- limited to the uploader and organizers/admins (who may need to review proof).
...
create policy "owners and staff can read proof files"
  ...
  using (
    ...
    and (
      ...
      or current_profile_role() in ('organizer', 'admin')
    )
  );
